...
async def whitelist_set(mode: int = 5) -> None:
    ...
    if mode == 5:
            with open("C:\Program Files (x86)\Steam\steamapps\common\Titanfall2\R2Northstar\save_data\Whitelist\whitelist_on.txt", "w") as f:
                f.write("0")
            with open("C:\Program Files (x86)\Steam\steamapps\common\Titanfall2\R2Northstar\save_data\Whitelist\whitelist.txt", "w") as f:
                f.write("")
            return
    elif mode == 4:
        with open("C:\Program Files (x86)\Steam\steamapps\common\Titanfall2\R2Northstar\save_data\Whitelist\whitelist_on.txt", "w") as f:
